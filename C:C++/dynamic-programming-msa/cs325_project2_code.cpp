/****************************************************************************************
 ** Program Filenames: cs325_project2_code.cpp
 ** Authors: Ethan Spiro, Barbara Hazlett, Wing Yee Leung
 ** Class: CS 325
 ** Due Date: 8/3/14
 **
 ** Description: DP algorithm solving the max sub array problem w/ DP table.
 ** Input: none
 ** Output: Displays the correct max sub array.
 **
 ** Compile line on flip: g++ -std=c++0x cs325_project2_code.cpp -o <your executable name>
 ***************************************************************************************/
...
int main() {
	...
	cout << "Maximum subArray sum using DP algorithm: " << algorithm_DP(allNegativeArray, length) << endl;
	cout << endl;
 
	//testing array 1
	length = (sizeof(testArray1)) / (sizeof(int));
	cout << "Testing array 1...answer should be 239" << endl;
	cout << "Maximum subArray sum using DP algorithm: " << algorithm_DP(testArray1, length) << endl;
	cout << endl;
 
	//testing array 2
	cout << "Testing array 2...answer should be 322" << endl;
	cout << "Maximum subArray sum using DP algorithm: " << algorithm_DP(testArray2, length) << endl;
	cout << endl;
 
	//testing array 3
	cout << "Testing array 3...answer should be 305" << endl;
	cout << "Maximum subArray sum using DP algorithm: " << algorithm_DP(testArray3, length) << endl;
	cout << endl;
 
	//testing array 4
	cout << "Testing array 4...answer should be 271" << endl;
	cout << "Maximum subArray sum using DP algorithm: " << algorithm_DP(testArray4, length) << endl;
	cout << endl;
 
	//testing array 5
	cout << "Testing array 5...answer should be 281" << endl;
	cout << "Maximum subArray sum using DP algorithm: " << algorithm_DP(testArray5, length) << endl;
	cout << endl;
 
	//testing array 6
	cout << "Testing array 6...answer should be 215" << endl;
	cout << "Maximum subArray sum using DP algorithm: " << algorithm_DP(testArray6, length) << endl;
	cout << endl;
 
	//testing array 7
	cout << "Testing array 7...answer should be 207" << endl;
	cout << "Maximum subArray sum using DP algorithm: " << algorithm_DP(testArray7, length) << endl;
	cout << endl;
 
	//testing array 8
	cout << "Testing array 8...answer should be 309" << endl;
	cout << "Maximum subArray sum using DP algorithm: " << algorithm_DP(testArray8, length) << endl;
	cout << endl;
 
	//testing array 9
	cout << "Testing array 9...answer should be 195" << endl;
	cout << "Maximum subArray sum using DP algorithm: " << algorithm_DP(testArray9, length) << endl;
	cout << endl;
 
	//testing array 10
	cout << "Testing array 10...answer should be 390" << endl;
	cout << "Maximum subArray sum using DP algorithm: " << algorithm_DP(testArray10, length) << endl;
	cout << endl;
