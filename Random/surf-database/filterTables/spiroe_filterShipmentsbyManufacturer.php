...
<div>
	<table>
		<tr>
			<td>Shipments Filtered By Manufacturer Results</td>
		</tr>
		<tr>
			<td>ID</td>
			<td>Product ID</td>
...
if(!($stmt = $mysqli->prepare("SELECT mtm_products_manufacturers.pm_id, products.p_name, 
	...
	INNER JOIN products ON products.p_id = mtm_products_manufacturers.pm_fk_product WHERE manufacturers.ma_id = ?"))){
	echo "Prepare failed: "  . $stmt->errno . " " . $stmt->error;
}
if(!($stmt->bind_param("i",$_POST['manufacturer']))){
